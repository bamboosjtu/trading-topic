...
description: "AI Berkshire skill: 深度公司系列：8 篇长文拆一家公司. Canonical source: .agents/skills/deep-company-series/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/deep-company-series/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
