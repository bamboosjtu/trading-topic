...
description: "AI Berkshire skill: 投研团队：四角色并行分析框架. Canonical source: .agents/skills/investment-team/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/investment-team/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
