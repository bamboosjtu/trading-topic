...
description: "AI Berkshire skill: 行业投资研究：产业链全景扫描 + 四大师个股分析框架. Canonical source: .agents/skills/industry-research/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/industry-research/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
