---
name: financial-data
description: "AI Berkshire skill: 财务数据获取与交叉验证规范. Canonical source: .agents/skills/financial-data/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/financial-data/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
