---
name: thesis-drift
description: "AI Berkshire skill: 投资论文漂移检测：分清事实变化与措辞变化. Canonical source: .agents/skills/thesis-drift/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/thesis-drift/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
