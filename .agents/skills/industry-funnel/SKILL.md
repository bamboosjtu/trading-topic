...
description: "AI Berkshire skill: 行业漏斗筛选：从全市场到 3 家的价值投资精选流程. Canonical source: .agents/skills/industry-funnel/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/industry-funnel/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
