---
name: thesis-tracker
description: "AI Berkshire skill: 投资论文追踪：买入后的纪律系统. Canonical source: .agents/skills/thesis-tracker/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/thesis-tracker/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
