---
name: wechat-article
description: "AI Berkshire skill: 微信公众号文章：作者-编辑-读者三Agent协作. Canonical source: .agents/skills/wechat-article/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/wechat-article/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
