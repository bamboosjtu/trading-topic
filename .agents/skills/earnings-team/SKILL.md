---
name: earnings-team
description: "AI Berkshire skill: 财报精读团队：四大师并行解读 + 公众号发布. Canonical source: .agents/skills/earnings-team/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/earnings-team/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
