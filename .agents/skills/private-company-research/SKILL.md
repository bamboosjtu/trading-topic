...
description: "AI Berkshire skill: 未上市公司研究：多Agent并行深度研究框架. Canonical source: .agents/skills/private-company-research/SKILL.md."
---

## Codex adapter note

The canonical repository copy is `.agents/skills/private-company-research/SKILL.md`; the generated `.claude/skills/` junction lets Claude Code and Codex use the same workflow.
